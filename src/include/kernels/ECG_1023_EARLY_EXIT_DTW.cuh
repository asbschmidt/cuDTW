#ifndef ECG_1023_EARLY_EXIT_DTW
#define ECG_1023_EARLY_EXIT_DTW
...
void ECG_1023_early_exit_DTW(  // replace DTW_1024_sub_warp
    value_t * Subject,
    value_t * Dist,
    index_t num_entries,
    ...
    const index_t base = (32/group_size)*blid;
    ...
    value_t subject_value0 = base+(thid/group_size) + (l%group_size) == 0 ? 0 : Subject[base+(thid/group_size) + 32*(l%group_size)-1];
    //const value_t subject_value0 = Subject[base+(thid/group_size)*num_features + 32*(l%group_size)-1];
    value_t subject_value1 = Subject[base+(thid/group_size) + 32*(l%group_size)-0];
    value_t subject_value2 = Subject[base+(thid/group_size) + 32*(l%group_size)+1];
    value_t subject_value3 = Subject[base+(thid/group_size) + 32*(l%group_size)+2];
    value_t subject_value4 = Subject[base+(thid/group_size) + 32*(l%group_size)+3];
    value_t subject_value5 = Subject[base+(thid/group_size) + 32*(l%group_size)+4];
    value_t subject_value6 = Subject[base+(thid/group_size) + 32*(l%group_size)+5];
    value_t subject_value7 = Subject[base+(thid/group_size) + 32*(l%group_size)+6];
    value_t subject_value8 = Subject[base+(thid/group_size) + 32*(l%group_size)+7];
    value_t subject_value9 = Subject[base+(thid/group_size) + 32*(l%group_size)+8];
    value_t subject_value10 = Subject[base+(thid/group_size) + 32*(l%group_size)+9];
    value_t subject_value11 = Subject[base+(thid/group_size) + 32*(l%group_size)+10];
    value_t subject_value12 = Subject[base+(thid/group_size) + 32*(l%group_size)+11];
    value_t subject_value13 = Subject[base+(thid/group_size) + 32*(l%group_size)+12];
    value_t subject_value14 = Subject[base+(thid/group_size) + 32*(l%group_size)+13];
    value_t subject_value15 = Subject[base+(thid/group_size) + 32*(l%group_size)+14];

    value_t subject_value16 = Subject[base+(thid/group_size) + 32*(l%group_size)+15];
    value_t subject_value17 = Subject[base+(thid/group_size) + 32*(l%group_size)+16];
    value_t subject_value18 = Subject[base+(thid/group_size) + 32*(l%group_size)+17];
    value_t subject_value19 = Subject[base+(thid/group_size) + 32*(l%group_size)+18];
    value_t subject_value20 = Subject[base+(thid/group_size) + 32*(l%group_size)+19];
    value_t subject_value21 = Subject[base+(thid/group_size) + 32*(l%group_size)+20];
    value_t subject_value22 = Subject[base+(thid/group_size) + 32*(l%group_size)+21];
    value_t subject_value23 = Subject[base+(thid/group_size) + 32*(l%group_size)+22];
    value_t subject_value24 = Subject[base+(thid/group_size) + 32*(l%group_size)+23];
    value_t subject_value25 = Subject[base+(thid/group_size) + 32*(l%group_size)+24];
    value_t subject_value26 = Subject[base+(thid/group_size) + 32*(l%group_size)+25];
    value_t subject_value27 = Subject[base+(thid/group_size) + 32*(l%group_size)+26];
    value_t subject_value28 = Subject[base+(thid/group_size) + 32*(l%group_size)+27];
    value_t subject_value29 = Subject[base+(thid/group_size) + 32*(l%group_size)+28];
    value_t subject_value30 = Subject[base+(thid/group_size) + 32*(l%group_size)+29];
    value_t subject_value31 = Subject[base+(thid/group_size) + 32*(l%group_size)+30];
    ...
    value_t S_last = subject_value31; // Subject[base+num_features-1];
    S_last = __shfl_sync(0xffffffff, S_last, 31);
    value_t S_second_last = subject_value30; // // Subject[base+num_features-2];
    S_second_last = __shfl_sync(0xffffffff, S_second_last, 31);
    value_t S_third_last = subject_value29; // Subject[base+num_features-3];
   ...
   const index_t group_id = thid%group_size;
    ...
    for (index_t k = 3; k < lane+group_size-1; k++) {
        ...
        if (counter%group_size == 0) {
            ...
            new_query_value = cQuery[i+2*(thid%group_size)-1];
        }
        query_value = __shfl_up_sync(0xFFFFFFFF, query_value, 1, 32);
    ...
    if(thid % group_size == group_size-1 && mask) {
	    Dist[(32/group_size)*blid+thid/group_size] = penalty_here31;
	    if (penalty_here31 < *threshold)
               update_bsf_system(threshold, penalty_here31);
    }
}
}
