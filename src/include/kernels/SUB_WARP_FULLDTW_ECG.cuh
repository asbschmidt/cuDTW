...
void sub_warp_FullDTW_ECG(  // replace DTW_1024_sub_warp
    value_t * Subject,
    value_t * Dist,
    index_t num_entries,
    ...
    const value_t subject_value0 = base+(thid/group_size) + (l%group_size) == 0 ? 0 : Subject[base+(thid/group_size) + 32*(l%group_size)-1];
    //const value_t subject_value0 = Subject[base+(thid/group_size)*num_features + 32*(l%group_size)-1];
    const value_t subject_value1 = Subject[base+(thid/group_size) + 32*(l%group_size)-0];
    const value_t subject_value2 = Subject[base+(thid/group_size) + 32*(l%group_size)+1];
    const value_t subject_value3 = Subject[base+(thid/group_size) + 32*(l%group_size)+2];
    const value_t subject_value4 = Subject[base+(thid/group_size) + 32*(l%group_size)+3];
    const value_t subject_value5 = Subject[base+(thid/group_size) + 32*(l%group_size)+4];
    const value_t subject_value6 = Subject[base+(thid/group_size) + 32*(l%group_size)+5];
    const value_t subject_value7 = Subject[base+(thid/group_size) + 32*(l%group_size)+6];
    const value_t subject_value8 = Subject[base+(thid/group_size) + 32*(l%group_size)+7];
    const value_t subject_value9 = Subject[base+(thid/group_size) + 32*(l%group_size)+8];
    const value_t subject_value10 = Subject[base+(thid/group_size) + 32*(l%group_size)+9];
    const value_t subject_value11 = Subject[base+(thid/group_size) + 32*(l%group_size)+10];
    const value_t subject_value12 = Subject[base+(thid/group_size) + 32*(l%group_size)+11];
    const value_t subject_value13 = Subject[base+(thid/group_size) + 32*(l%group_size)+12];
    const value_t subject_value14 = Subject[base+(thid/group_size) + 32*(l%group_size)+13];
    const value_t subject_value15 = Subject[base+(thid/group_size) + 32*(l%group_size)+14];

    const value_t subject_value16 = Subject[base+(thid/group_size) + 32*(l%group_size)+15];
    const value_t subject_value17 = Subject[base+(thid/group_size) + 32*(l%group_size)+16];
    const value_t subject_value18 = Subject[base+(thid/group_size) + 32*(l%group_size)+17];
    const value_t subject_value19 = Subject[base+(thid/group_size) + 32*(l%group_size)+18];
    const value_t subject_value20 = Subject[base+(thid/group_size) + 32*(l%group_size)+19];
    const value_t subject_value21 = Subject[base+(thid/group_size) + 32*(l%group_size)+20];
    const value_t subject_value22 = Subject[base+(thid/group_size) + 32*(l%group_size)+21];
    const value_t subject_value23 = Subject[base+(thid/group_size) + 32*(l%group_size)+22];
    const value_t subject_value24 = Subject[base+(thid/group_size) + 32*(l%group_size)+23];
    const value_t subject_value25 = Subject[base+(thid/group_size) + 32*(l%group_size)+24];
    const value_t subject_value26 = Subject[base+(thid/group_size) + 32*(l%group_size)+25];
    const value_t subject_value27 = Subject[base+(thid/group_size) + 32*(l%group_size)+26];
    const value_t subject_value28 = Subject[base+(thid/group_size) + 32*(l%group_size)+27];
    const value_t subject_value29 = Subject[base+(thid/group_size) + 32*(l%group_size)+28];
    const value_t subject_value30 = Subject[base+(thid/group_size) + 32*(l%group_size)+29];
    const value_t subject_value31 = Subject[base+(thid/group_size) + 32*(l%group_size)+30];
